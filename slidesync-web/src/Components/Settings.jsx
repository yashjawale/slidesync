        ...
        <>
            <div className='flex flex-col justify-between'>
                <div className="menu flex flex-col justify-start items-start mx-6 gap-1">
                    ...
                    <span className="material-symbols-outlined py-2 text-3xl" onClick={() => {
                    ...
                    <ul className='flex flex-col justify-evenly pt-8 gap-2 max-w-[350px]'>
                        ...
                        <List settingName="Prevent the screen from sleeping" handleClick={handleSleep} status={state.sleep}/>
